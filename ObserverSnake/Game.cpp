...
Game::Game() : running(true)
{
	...
	// Add players profile
	sceneStateMachine.addPlayer(std::make_shared<Player>(SCREEN_WIDTH / 10 * 9)); // UI on the 9/10 of screen width
	sceneStateMachine.addPlayer(std::make_shared<Player>(SCREEN_WIDTH / 10)); // like player 1 but 1/10 screen width
